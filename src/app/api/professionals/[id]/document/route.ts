...
import { readProfessionalDocument } from '@/server/services/professional-registrations';
...
export const GET = defineRoute(
  async ({ user, params, searchParams }) => {
    ...
    const { bytes, mimeType, fileName } = await readProfessionalDocument(user, params.id, index);
