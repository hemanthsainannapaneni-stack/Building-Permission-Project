...
<p class="sub">Building Permission — BBAS demonstration</p>
${meta([
...
<p>The document named above is enclosed.</p>`;
  return page(`Outward ${d.outwardNumber}`, body, 'DEMO DOCUMENT — a dispatch slip generated by the BBAS demonstration.');
}
